...
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/gbc/mGBA/mGBA.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/gbc/gpSP/gpSP.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/gbc/VBA Next/VBA Next.rmp"
...
echo "SECOND - remapping other 2 button emus that use (confirm, reversed?) Circle for jump and Cross for fire, to use Cross for jump and Square for fire..."
echo "Remapping Sega SG-1000 cores..."
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/sg-1000/FinalBurn Neo/FinalBurn Neo.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/sg-1000/Gearsystem/Gearsystem.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/sg-1000/Genesis Plus GX/Genesis Plus GX.rmp"
echo "Remapping Sega Master System cores..."
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/mastersystem/SMS Plus GX/SMS Plus GX.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/mastersystem/Gearsystem/Gearsystem.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/mastersystem/FinalBurn Neo/FinalBurn Neo.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/mastersystem/Genesis Plus GX/Genesis Plus GX.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/mastersystem/PicoDrive/PicoDrive.rmp"
...
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/msx/FinalBurn Neo/FinalBurn Neo.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/msx/fMSX/fMSX.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/msx/blueMSX/blueMSX.rmp"

echo "THIRD - remapping other 2 button emus that use (confirm, reversed?) Circle for fire and Cross for jump, to use Cross for jump and Square for fire..."
echo "Remapping Atari Lynx cores..."
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/atarilynx/Handy/Handy.rmp"
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/atarilynx/Beetle Lynx/Beetle Lynx.rmp"
echo "Remapping Wonderswan cores..."
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/wonderswan/Beetle WonderSwan/Beetle WonderSwan.rmp"
echo "Remapping Wonderswan Color cores..."
cp --verbose "reference/opt/retropie/configs/all/2buttonNesEmulatorRemap.rmp" "/opt/retropie/configs/wonderswancolor/Beetle WonderSwan/Beetle WonderSwan.rmp"
