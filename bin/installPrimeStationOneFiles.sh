...
cp --verbose "reference/opt/retropie/configs/all/2buttonSmsReverseEmulatorRemap.rmp" "/opt/retropie/configs/gamegear/FinalBurn Neo/FinalBurn Neo.rmp"
mkdir -vp "/opt/retropie/configs/gamegear/Genesis Plus GX"
cp --verbose "reference/opt/retropie/configs/all/2buttonSmsReverseEmulatorRemap.rmp" "/opt/retropie/configs/gamegear/Genesis Plus GX/Genesis Plus GX.rmp"
mkdir -vp "/opt/retropie/configs/gamegear/Gearsystem"
cp --verbose "reference/opt/retropie/configs/all/2buttonSmsReverseEmulatorRemap.rmp" "/opt/retropie/configs/gamegear/Gearsystem/Gearsystem.rmp"
mkdir -vp "/opt/retropie/configs/gamegear/SMS Plus GX"
cp --verbose "reference/opt/retropie/configs/all/2buttonSmsReverseEmulatorRemap.rmp" "/opt/retropie/configs/gamegear/SMS Plus GX/SMS Plus GX.rmp"
