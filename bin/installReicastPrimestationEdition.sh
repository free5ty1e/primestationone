...
sed -i '/gitPullOrClone/c\gitPullOrClone "$md_build" https://github.com/free5ty1e/reicast-emulator.git free5ty1e/ps3-controller-mappings' ~/RetroPie-Setup/scriptmodules/emulators/reicast.sh
