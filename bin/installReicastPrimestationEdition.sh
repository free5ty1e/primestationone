...
sed -i '/gitPullOrClone/c\gitPullOrClone "$md_build" https://github.com/free5ty1e/reicast-emulator.git free5ty1e/rpi2/moar-merged-improvements' ~/RetroPie-Setup/scriptmodules/emulators/reicast.sh
