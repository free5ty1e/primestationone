...
sudo apt-get update && sudo apt-get install -y glib-networking gobject-introspection fuse curl wget build-essential libglib2.0-dev libssl-dev libcurl4-openssl-dev libgirepository1.0-dev libcurl4-gnutls-dev p7zip pv libssl-dev glib-networking
